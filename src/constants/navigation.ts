...
export const navigation: NavigationItem[] = [
  {
    ...
    children: [
      ...
      { label: 'Installation Guide', href: '/docs/installation', badge: 'Updated' },
    ],
  },
  {
    label: 'UI Components',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Announcement Banner', href: '/docs/announcement', badge: 'New' },
    ],
  },
  {
    label: 'Form Inputs',
  ...
  },
  {
    ...
    children: [
      ...
      { label: 'Content Carousel', href: '/docs/carousel', badge: 'New' },
