...
import BentoGridCom from "@/app/docs/bento-grid/bento-grid";
...
import ComboBoxView from "@/app/docs/combo-box/combo-box-view";
...
import Footer3 from "@/app/docs/footer/footer3";
...
import AnimationModalView from "@/app/docs/modal/animation-modal";
import BasicModalView from "@/app/docs/modal/basic-modal";
import ConfirmationModalView from "@/app/docs/modal/confirmation-modal";
import FormModalView from "@/app/docs/modal/form-modal";
import SizeVariantsView from "@/app/docs/modal/size-variants";
import SuccessModalView from "@/app/docs/modal/success-modal";
...
import NexusOrb from "@/app/docs/orbits/nexusorb";
import NexusOrbSup from "@/app/docs/orbits/nexusorbsup";
import Spider from "@/app/docs/orbits/spider";
...
export const ComponentRegistry: Record<string, React.ComponentType> = {
  ...
  modal: BasicModalView,
  "animation-modals": AnimationModalView,
  "modal-sizes": SizeVariantsView,
  "form-modal": FormModalView,
  "confirmation-modals": ConfirmationModalView,
  "success-modals": SuccessModalView,
  "combo-box": ComboBoxView,
