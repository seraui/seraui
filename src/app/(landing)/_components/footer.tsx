...
export const Footer = () => {
  return (
    ...
    <footer className="sticky bottom-0 z-50 border-t border-zinc-200 dark:border-zinc-800 bg-white/60 dark:bg-zinc-900/60 backdrop-blur px-4 sm:px-6 py-4 sm:py-6 text-xs sm:text-sm">
