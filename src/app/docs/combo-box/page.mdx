export const metadata = {
    title: 'React Combo Box Component | Sera UI',
...
rows={[
  ["option","string[]","[]","Array of options to display in the dropdown."],
  ["placeholder","string","Select an option...","Placeholder text for the input field"],
  ["onSelect","function","undefined","Callback function called when an option is selected"],
]}
