...
const NotificationItem = ({ title, message, time, unread = false, onMarkRead, onDismiss }: NotificationItemProps) => (
    <div className={`p-4 border-b border-zinc-200 dark:border-zinc-700 last:border-b-0 ${unread ? 'bg-blue-50 dark:bg-blue-950/20' : ''}`}>
...
export default function NotificationDropdown() {
    const [notifications, setNotifications] = useState([
        { id: 1, title: "New message", message: "You have a new message from Sarah", time: "2 min ago", unread: true },
        { id: 2, title: "System update", message: "Your system has been updated successfully", time: "1 hour ago", unread: true },
        { id: 3, title: "Payment received", message: "Payment of $99.00 has been processed", time: "3 hours ago", unread: false },
        { id: 4, title: "Welcome!", message: "Welcome to our platform. Get started with your first project.", time: "1 day ago", unread: false },
    ]);
