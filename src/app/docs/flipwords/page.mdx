export const metadata = {
    title: 'React Flip Words Component - React and Next.js UI Components | Sera UI',
    description: 'Animated flip words component with smooth transitions and customizable word arrays. Perfect for dynamic headings and rotating text displays.',
    keywords: [
        'React flip words',
        ...
        'text transition',
        'dynamic headings',
        'Tailwind CSS flip text',
        'UI text animation',
        'word carousel',
        'Sera UI components'
    ],
    openGraph: {
        title: 'Flip Words Component - Sera UI',
        description: 'Animated React flip words component with smooth transitions and customizable word arrays for dynamic text displays.',
        type: 'article',
        url: '/docs/flipwords',
        images: [
          {
