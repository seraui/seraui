export const metadata = {
    title: 'React Text Reveal Component - React and Next.js UI Components | Sera UI',
    description: 'Animated text reveal component with smooth transitions and customizable reveal effects. Perfect for creating engaging text animations and content reveals.',
    keywords: [
        'React text reveal',
        'text animation',
        'reveal animation',
        ...
        'text effects',
        'Tailwind CSS text reveal',
        'UI text animation',
        'reveal effect',
        'Sera UI components'
    ],
    openGraph: {
        title: 'Text Reveal Component - Sera UI',
        description: 'Animated React text reveal component with smooth transitions and customizable reveal effects for engaging text animations.',
        type: 'article',
        url: '/docs/textreveal',
        images: [
          {
...
# Text Reveal Animation <AI dir="left"/>
