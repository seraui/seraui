      ...
      {[1, 2, 3, 4, 5].map((value) => (
        <React.Fragment key={value}>
          ...
          <label
            ...
            className="
              cursor-pointer text-gray-400 text-2xl transition-transform duration-300
              hover:scale-125 hover:text-amber-400 peer-checked:text-amber-500
              peer-checked:drop-shadow-glow
              peer-hover:text-amber-500
            "
          >
            <svg
              xmlns="http://www.w3.org/2000/svg"
              className="w-8 h-8 fill-current transition-all duration-300"
              viewBox="0 0 576 512"
            >
