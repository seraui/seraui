...
const PatternDemo = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col items-center justify-center space-y-12 p-6">
      <h1 className="text-4xl font-bold">🔐 Pattern Lock Demo</h1>

      {/* Step 1: Set Pattern */}
      <div className="w-full max-w-xl bg-gray-800 p-6 rounded-2xl shadow-lg">
        <h2 className="text-2xl font-semibold mb-4">Step 1: Set a Pattern</h2>
        <PatternLock
          mode="set"
      ...
      {savedPattern.length > 0 && (
        <div className="w-full max-w-xl bg-gray-800 p-6 rounded-2xl shadow-lg">
          <h2 className="text-2xl font-semibold mb-4">Step 2: Unlock</h2>
          <PatternLock
            mode="unlock"
