export const metadata = {
    title: 'React Card Component - React and Next.js UI Components | Sera UI',
    description: 'Modern and customizable card components with various styles, hover effects, and layouts. Perfect for displaying content in organized sections.',
    keywords: [
    ...
    openGraph: {
        title: 'Card Component - Sera UI',
        description: 'Modern React card components with various styles, hover effects, and layouts for organizing content beautifully.',
        type: 'article',
        url: '/docs/card',
    },
    twitter: {
