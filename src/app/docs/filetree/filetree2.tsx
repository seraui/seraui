...
const FileIcon = () => (
  // Updated file icon as per user request
  <svg className="w-5 h-5 mr-2 shrink-0" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
...
const FolderIcon = ({ isOpen }: FolderIconProps) => (
  <svg className="w-5 h-5 mr-2 shrink-0" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke="currentColor">
    {isOpen ? (
    ...
    <div className="text-gray-700 dark:text-gray-300 relative">
      ...
      >
        <div className="flex items-center flex-grow">
          {isFolder ? <ChevronIcon isOpen={isOpen} /> : <div className="w-4 shrink-0"></div>}
