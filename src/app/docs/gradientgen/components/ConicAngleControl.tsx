...
interface ConicAngleControlProps {
  angle: number;
  onChange: (angle: number) => void;
  isDark: boolean;
}

export function ConicAngleControl({ angle, onChange }: ConicAngleControlProps) {
  ...
  return (
    <div className="flex items-center gap-4 justify-center">
      <span className="text-sm font-medium text-gray-600 dark:text-gray-300">Start Angle</span>
      <div
        ref={knobRef}
