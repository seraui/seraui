export const metadata = {
    title: 'React Two Step Authentication Component - React and Next.js UI Components | Sera UI',
    description: 'Secure two-step authentication component with OTP input, verification codes, and modern styling. Perfect for enhanced security and user authentication flows.',
    keywords: [
        'React two step auth',
    ...
    openGraph: {
        title: 'Two Step Authentication Component - Sera UI',
        description: 'Secure React two-step authentication component with OTP input, verification codes, and modern styling for enhanced security.',
        type: 'article',
        url: '/docs/twostep',
        images: [
          {
...
# Two-Step Verification <AI dir="left"/>
