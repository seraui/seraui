export const metadata = {
  ...
  openGraph: {
    title: "Sera UI – React & Next.js Component Library",
    description:
...
> ⚡ Not a package. Not a black box. Just code you own and control.
...
1. **Browse Components** – Explore the [Sera UI library](https://seraui.com/components)
...
* 📖 [View All Components](https://seraui.com/components)
