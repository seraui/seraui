export const metadata = {
    title: 'React Footer Component - React and Next.js UI Components | Sera UI',
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<Footer2 />} componentName="footer-2" />
  </TabsContent>
  <TabsContent value="code">
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<Footer3 />} componentName="footer-3" />
  </TabsContent>
  <TabsContent value="code">
