export const metadata = {
    title: 'React Tabs Component - React and Next.js UI Components | Sera UI',
    description: 'Modern and accessible tabs component with smooth animations, keyboard navigation, and customizable styling. Perfect for organizing content in tabbed interfaces.',
    keywords: [
    ...
    openGraph: {
        title: 'Tabs Component - Sera UI',
        description: 'Modern React tabs component with smooth animations, keyboard navigation, and customizable styling for organizing content.',
        type: 'article',
        url: '/docs/tabs',
        images: [
          {
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<TabsView />} componentName="tabs" />
  </TabsContent>
