...
#  Carousel Cards
A carousel component that displays cards with images, titles, and descriptions. Features smooth animations, drag interactions, and autoplay functionality.
...
<Tabs defaultValue="preview" className="">
  ...
  <TabsContent value="preview">
    <ComponentRenderer component={<CarouselCards />} componentName="CarouselCards" />
  </TabsContent>
  <TabsContent value="code">
    <CodeBlock filePath="src/app/docs/carousel/carousel2.tsx" />
  </TabsContent>
</Tabs>