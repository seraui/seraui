...
const CenterFlowerIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 200 200" width="100%" height="100%" className="coolshapes flower-3">
        ...
        <defs>
            <filter id="filter0_f_748_4691_v3" width="361.583" height="346.593" x="-72" y="-61.593" colorInterpolationFilters="sRGB" filterUnits="userSpaceOnUse">
                <feFlood floodOpacity="0" result="BackgroundImageFix"></feFlood>
                <feBlend in="SourceGraphic" in2="BackgroundImageFix" result="shape"></feBlend>
                <feGaussianBlur result="effect1_foregroundBlur_748_4691" stdDeviation="30"></feGaussianBlur>
            </filter>
            <linearGradient id="paint0_linear_748_4691_v3" x1="200" x2="0" y1="0" y2="200" gradientUnits="userSpaceOnUse">
        ...
        <defs>
            <filter id="cs_noise_1_flower-3_v3" width="100%" height="100%" x="0%" y="0%" filterUnits="objectBoundingBox">
